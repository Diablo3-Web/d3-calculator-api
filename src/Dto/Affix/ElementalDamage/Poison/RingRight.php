<?php
/**
 * Poison damage affix for right ring entity.
 *
 * PHP version 5
 *
 * @category  D3W
...
namespace D3W\Calculator\Dto\Affix\ElementalDamage\Poison;

use D3W\Calculator\Dto\Affix\ElementalDamage\Poison;
 ...
 *
 * @category  Domain
 * @package   D3W\Calculator\Dto\Affix\ElementalDamage\Poison
 * @author    Angel <angel.blizzard.mvp@gmail.com>
 * @copyright 2015 Diablo3-Web
 * @license   GNU GPLv3
 * @link      https://github.com/Diablo3-Web
...
class RingRight extends Poison
{
    const MIN = 15.0;
