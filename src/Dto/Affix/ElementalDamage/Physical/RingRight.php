<?php
/**
 * Physical damage affix for right ring entity.
 *
 * PHP version 5
 *
 * @category  D3W
...
namespace D3W\Calculator\Dto\Affix\ElementalDamage\Physical;

use D3W\Calculator\Dto\Affix\ElementalDamage\Physical;
 ...
 *
 * @category  Domain
 * @package   D3W\Calculator\Dto\Affix\ElementalDamage\Physical
 * @author    Angel <angel.blizzard.mvp@gmail.com>
 * @copyright 2015 Diablo3-Web
 * @license   GNU GPLv3
 * @link      https://github.com/Diablo3-Web
...
class RingRight extends Physical
{
    const MIN = 15.0;
